...
int main() {
	std::vector<Expected> cases = {
		...
		{"ordinary multiline string", "func f():\n\tvar x = \"multi\n<caret>line\"", CaretLexicalContext::String},
		{"raw multiline string", "func f():\n\tvar x = r\"\"\"multi\n<caret>line\"\"\"", CaretLexicalContext::String},
		{"escaped triple delimiter", "func f():\n\tvar x = \"\"\"a \\\"\"\" <caret>still literal\"\"\"", CaretLexicalContext::String},
		{"before opening quote", "func f():\n\touter(<caret>\"text\")", CaretLexicalContext::Code,
			CaretRole::CallArgument, {}, {}, {}, "outer", 0},
		{"after closing quote", "func f():\n\touter(\"text\"<caret>)", CaretLexicalContext::Code,
			CaretRole::CallArgument, {}, {}, {}, "outer", 0},
		{"multiline argument punctuation", "func f():\n\touter(\"\"\"),([ #\n\"\"\", <caret>)", CaretLexicalContext::Code,
			CaretRole::CallArgument, {}, {}, {}, "outer", 1},
		{"continued assignment", "func f():\n\tvar current = \\\n\t\t<caret>", CaretLexicalContext::Code,
			CaretRole::AssignmentValue, {}, {}, {}, {}, {}, {}, {}, {}, "current"},
		{"partial future keyword", "func f():\n\tvar x = 1 i<caret>f true else 2", CaretLexicalContext::Code},
